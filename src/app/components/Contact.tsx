                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">MMC: 07086080230</p>
                      <p className="text-sm text-gray-600">Pharmacy: 07030943250 / 09018911685</p>
                      <p className="text-sm text-gray-600">Outreach: 09126976533</p>
                      <p className="text-sm text-gray-600">General: 09019305059</p>
