        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/services/medical-centre" className="hover:text-blue-400 transition-colors">Medical Centre</Link></li>
              <li><Link to="/services/medical-supplies" className="hover:text-blue-400 transition-colors">Medical Supplies</Link></li>
              <li><Link to="/store" className="hover:text-blue-400 transition-colors">Pharmacy Store</Link></li>
            </ul>
          </div>
