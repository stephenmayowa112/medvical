    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-2 text-lg">{article.title}</p>
          <p className="text-gray-400 mb-6">This article is being prepared by our medical team. Check back soon!</p>
          <Link to="/health-education">
            <Button className="bg-blue-600 hover:bg-blue-700">
              <ArrowLeft className="w-4 h-4 mr-2" />
              Back to Health Education
