        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="max-w-4xl mx-auto space-y-4 text-center">
              ...
              <p className="text-gray-700 leading-relaxed">
                Our social impact programmes are complemented by <a href="https://simhealthafrica.org" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 hover:underline font-medium">simHealth</a>, through systematic support for health programmes; research, training and dissemination; social innovation; policy, advocacy and collaboration.
              </p>
            </div>
          </motion.div>
